...
def get_dataset(dataset, args):
    ...
    val_metric = VOCMApMetric(iou_thresh=0, class_names=['bleeding_site'])
...
if __name__ == '__main__':
    ...
    if args.syncbn and len(ctx) > 1:
        ...
        net = get_model(net_name, pretrained_base=True, norm_layer=gluon.nn.BatchNorm, classes = np.array(['bleeding_site']))
        async_net = net
