...
def get_dataset(dataset, args):
    train_dataset = LstDetection('dataset/training_set.lst', root=os.path.expanduser('.'))
    val_dataset = LstDetection('dataset/validation_set_A.lst', root=os.path.expanduser('.'))
...
if __name__ == '__main__':
    ...
    if args.custom_model:
        ...
        net = get_model('faster_rcnn_resnet101_v1d_coco', pretrained_base=True, per_device_batch_size=args.batch_size // num_gpus, **kwargs)
        net.reset_class(['bleeding_site'])
