...
class ImageFolder(Dataset):
    ...
    def __getitem__(self, index):
        ...
        ### none of the below is required as our data - 
            ### same size data, 800x800
            ### gray scale - no channel dimension, so only 2 dim input
...
class ListDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # ### above code ignored grayscale images! we'll add code for handling both
        ...
        # input_img = np.transpose(input_img, axes=(2, 0, 1)) #dbt0 why channels first??
        ...
        ### again none of this is required for now as we have the labels in the req format already
